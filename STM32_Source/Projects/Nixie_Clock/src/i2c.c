...
void I2C2_Init(uint16_t addr, uint32_t speed)
{
  ...
  /* I2C2 SDA 和 SCL 配置: PB10--I2C2_SCL, PB11--I2C2_SDA */
...
{
  uint8_t value = 0;
  I2C2_BufferRead(&value, 1, SlaveAddress);
...
{
  I2C2_BufferWrite(&data, 1, SlaveAddress);
}
