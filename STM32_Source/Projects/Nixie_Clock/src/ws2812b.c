...
uint8_t pixelBuffer[WS2812B_NUM * 9] = {0};
...
void WS2812B_Init(void)
{
  ...
  DMA_InitStructure.DMA_BufferSize = WS2812B_NUM * 9; //DMA通道的DMA缓存的大小
...
void WS2812B_Show(void)
{
  ...
  DMA_SetCurrDataCounter(DMA1_Channel3, 9 * WS2812B_NUM);//DMA通道的DMA缓存的大小
