...
int main(void)
{
    ...
    button_attach(&key0, LONG_PRESS_START,  key0_long_pressed_handler); // key0 长按
    button_attach(&key1, SINGLE_CLICK,      key1_single_clicked_handler);
    button_attach(&key1, LONG_PRESS_START,  key1_long_pressed_handler);
    button_attach(&key2, SINGLE_CLICK,      key2_single_clicked_handler);
    button_attach(&key2, LONG_PRESS_START,  key2_long_pressed_handler);
